...
export default function Carousel() {
  ...
  return (
    <Layout title="">
      <div className="mb-[30px] flex h-screen w-full items-end justify-center">
        <div className="flex h-screen w-[95%] flex-row flex-nowrap justify-center">
          <div className="absolute h-screen w-[95%]">
            <div
              className={`absolute h-screen w-full rounded-[2px] bg-cover transition-all duration-300 ease-in ${carousel[contador]}`}
            ></div>
            ...
            <div className="absolute h-screen w-full">
              <div className="w-[60%] p-[100px]">
                ...
                <p className="text-[1.6rem] text-white">
                  Level up your comfort this season with our new Winter
                  Collection — all new joggers, beanies, drinkware, and for the
                  first time ever, Octocookie cutters!
                </p>
              </div>
            </div>
            ...
            <div className="absolute top-[50%] m-auto my-0 w-full lg:top-[50%]">
              <button
                ...
                className="bg-colReser lg:hover:bg-colSliderHover absolute left-0 flex h-10 w-10 items-center justify-center rounded-[4px] transition duration-300 ease-in-out lg:h-[40px] lg:w-[40px]"
              >
                <Image
              ...
              <button
                onClick={() => nextClick()}
                className="bg-colReser lg:hover:bg-colSliderHover absolute right-0 flex h-10 w-10 items-center justify-center rounded-[4px] transition duration-300 ease-in-out lg:h-[40px] lg:w-[40px]"
              >
                <Image
